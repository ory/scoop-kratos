...
# Contribute to Ory scoop-kratos<!-- omit in toc -->
...
_Please note_: We take Ory scoop-kratos's security and our users' trust very
seriously. If you believe you have found a security issue in Ory scoop-kratos,
...
scoop-kratos's direction. A great way to
do this is via
[Ory scoop-kratos Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/scoop-kratos/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory scoop-kratos?](#communication)
...
- I want to talk to other Ory scoop-kratos users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  scoop-kratos.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/scoop-kratos)

- I would like updates about new versions of Ory scoop-kratos.
...
[list of good first issues](https://github.com/ory/scoop-kratos/labels/good%20first%20issue).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory scoop-kratos.
...
- **Help with open issues.** We have a lot of open issues for Ory scoop-kratos and
...
Check out [Ory scoop-kratos Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory scoop-kratos,
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/scoop-kratos/blob/master/.github/workflows/conventional_commits.yml)
...
before getting started to ensure your work is consistent with Ory scoop-kratos's
...
[Contributor License Agreement](https://cla-assistant.io/ory/scoop-kratos).
...
git clone git@github.com:ory/ory/scoop-kratos.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/scoop-kratos.git
